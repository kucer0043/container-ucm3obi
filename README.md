...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ucm3obi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ucm3obi.containers.anotherwebservice.com/
...
```
git clone git@github.com:kucer0043/container-ucm3obi.git
cd container-ucm3obi
```
...
```
docker attach container-ucm3obi
```
